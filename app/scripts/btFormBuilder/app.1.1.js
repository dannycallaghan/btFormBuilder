(function () {
    ...
    .factory('btFormBuilderDataService', function () {
      ...
      data = {
        details: {
          ...
          success: {
            value : 'Thank you. Your form has been submitted.'
          },
          error: {
            value : 'Sorry, we could not submit your form'
          },
          name: {
            value : ''
          }
    ...
    .directive('btFormBuilderGeneratorForm', ['btFormBuilderDataService', 'btFormBuilderGeneratorTabsService', function (btFormBuilderDataService, btFormBuilderGeneratorTabsService) {
      return {
        ...
        controller: function ($scope) {
          ...
          $scope.$watch('form.data.details.name.value', function (newValue, oldValue) {
  ...
  function btFormBuilderElementRadioTemplate () {
    var template = '' +
      ...
      '       data-ng-required="element.required"' +
      '       data-ng-model="ngModel.value"' +
      '       data-ng-checked="ngModel.value === choice.value" ' +
      '     />' +
      '     {{::choice.label}}' +
      '   </label>' +
      ' </div>';
