(function () {
  ...
  function btfbElementTemplate () {
    var template = '' +
      ...
      ' <div btfb-element-field data-features="features"></div>' +
  ...
  function btfbElementCheckboxTemplate () {
    var template = '' +
      '<input class="form-control" type="checkbox" data-ng-model="features.field_value" />';
    return template;
  }
